...
export const generateArtistPageFromSuno = async (sunoPlaylistUrl: string): Promise<GeneratedArtistPageData> => {
    ...
    **CRITICAL INSTRUCTIONS:**
    ...
    try {
        // FIX: Correctly access the text content of the response per Gemini API guidelines.
...
// FIX: Removed incorrect `async` keyword to prevent returning a nested promise.
export const getCodeAssistantResponseStream = (
    fileName: string,
    fileContent: string,
    userPrompt: string,
