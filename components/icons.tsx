...
export const YoutubeIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M2.5 17a24.12 24.12 0 0 1 0-10C2.5 6 7.5 2 12 2s9.5 4 9.5 5a24.12 24.12 0 0 1 0 10c0 1-5 5-9.5 5s-9.5-4-9.5-5Z"/><path d="m10 15 5-3-5-3z"/></svg>
);
...
export const GridIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><rect width="18" height="18" x="3" y="3" rx="2"/><rect width="7" height="7" x="3" y="3" rx="0"/><rect width="7" height="7" x="14" y="3" rx="0"/><rect width="7" height="7" x="14" y="14" rx="0"/><rect width="7" height="7" x="3" y="14" rx="0"/></svg>
);

export const VideoIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.934a.5.5 0 0 0-.777-.416L16 11"/><rect x="2" y="6" width="14" height="12" rx="2"/></svg>
);
...
export const KeyIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M2 18v3c0 .6.4 1 1 1h4v-3h3v-3h2l1.4-1.4a6.5 6.5 0 1 0-4-4Z"/><circle cx="16.5" cy="7.5" r=".5"/></svg>
);

export const PlaylistIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><circle cx="12" cy="12" r="10" /><path d="M12 6v6l4 2" /><path d="M16 6h4"/><path d="M16 10h4" /><path d="M16 14h4" /><path d="M16 18h4" /></svg>
);
...
export const PackageIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M21 10V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v2"/><path d="M21 14v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><path d="M3 10h18"/><path d="M12 2v8.5"/><path d="m3.5 7.5 8.5 4.9 8.5-4.9"/><path d="M3.5 16.5 12 21.4l8.5-4.9"/></svg>
);
...
export const BitcoinIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M11.767 19.089c3.88.733 7.02-1.232 7.02-5.44C18.787 7.127 15.642 4.5 12 4.5S5.213 7.127 5.213 13.65c0 4.184 3.143 6.173 7.02 5.44m-1.74-13.31a.5.5 0 0 0-.525.525v2.03c0 .29.235.525.525.525h1.237c1.17 0 2.12.95 2.12 2.12s-.95 2.12-2.12 2.12h-1.237a.525.525 0 0 1-.525-.525v-2.03c0-.29-.235-.525-.525-.525H8.55V14.8c0 .29.235.525.525.525h1.767c1.17 0 2.12.95 2.12 2.12s-.95 2.12-2.12 2.12H8.55a.525.525 0 0 1-.525-.525v-2.03c0-.29-.235-.525-.525-.525h-1.237c-1.17 0-2.12-.95-2.12-2.12s.95-2.12 2.12-2.12h1.237a.525.525 0 0 0 .525-.525v-2.03c0-.29.235-.525.525-.525h2.642m-1.74-2.12h1.48v19.43h-1.48z"/></svg>
);

export const EthereumIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 2 6 12l6 10 6-10z"/><path d="m6 12 6-3 6 3"/><path d="m6 12 6 10v-7"/></svg>
);
...
export const WalletIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M20 12V8H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v4"/><path d="M4 6v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V12H4z"/><path d="M18 12a2 2 0 0 0-2 2c0 1.1.9 2 2 2a2 2 0 0 0 2-2c0-1.1-.9-2-2-2z"/></svg>
);
...
export const SparklesIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M9.93 13.5a2.5 2.5 0 1 1-3.53-3.53 2.5 2.5 0 0 1 3.53 3.53z"/>
        <path d="M18 8a2 2 0 1 1-2.83-2.83A2 2 0 0 1 18 8z"/>
        <path d="m22 2-2.5 2.5"/>
        <path d="m13.5 10.5-2.5 2.5"/>
        <path d="M2 22l2.5-2.5"/>
        <path d="M10.5 13.5 8 16"/>
        <path d="M16 2a2 2 0 1 1-2.83 2.83A2 2 0 0 1 16 2z"/>
    </svg>
);
...
export const AppleIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M17.485 15.34c.05-1.35.637-2.62 1.6-3.42-.988-.85-1.54-2.21-1.54-3.66 0-2.48 2.03-4.24 4.455-4.24.16 0 .33.01.485.02-2.075-1.59-4.73-2.3-7.255-2.3-2.91 0-5.69 1.25-7.55 3.35-1.37 1.54-2.26 3.59-2.26 5.8 0 2.4 1.13 4.88 2.94 6.35 1.52 1.23 3.41 1.91 5.4 1.91 2.27 0 4.49-.93 6.11-2.11zm-2.88-10.74c.95-.98 1.52-2.31 1.52-3.6h-2.99c-.11.89-.52 1.76-1.16 2.45-.89.92-2.14 1.54-3.48 1.54-.53 0-1.05-.11-1.52-.3-.7-.27-1.4-.69-2.01-1.25-.97-.9-1.63-2.14-1.78-3.44h3.13c.01.02.02.03.03.05.02.01.03.03.05.04.14.07.28.14.42.22.42.23.86.43 1.32.58.91.31 1.88.42 2.85.29z"/>
  </svg>
);

export const FacebookIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10s10-4.48 10-10S17.52 2 12 2zm3.31 11.9h-2.29v7.1h-3.02v-7.1H8.4V9.62h1.59V8.04c0-1.3.65-2.48 2.31-2.48h1.8v2.28h-1.3c-.35 0-.71.18-.71.73v1.05h2.02l-.28 2.28z"/>
  </svg>
);
...
export const PlayFilledIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <polygon points="5 3 19 12 5 21 5 3"/>
  </svg>
);
export const PauseFilledIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className={className}>
...
export const PlayCircleIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className={className}><circle cx="12" cy="12" r="10"/><polygon points="10 8 16 12 10 16 10 8"/></svg>
);

export const PauseCircleIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className={className}><circle cx="12" cy="12" r="10"/><line x1="10" y1="15" x2="10" y2="9"/><line x1="14" y1="15" x2="14" y2="9"/></svg>
);

export const PlayingIndicatorIcon: React.FC<IconProps> = ({ className }) => (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
        <g>
            <circle cx="12" cy="12" r="4" className="opacity-75" />
            <circle cx="12" cy="12" r="4" className="animate-pulse-rings-1" />
            <circle cx="12" cy="12" r="4" className="animate-pulse-rings-2" />
        </g>
    </svg>
);
...
export const BrainCircuitIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 20a8 8 0 1 0 0-16 8 8 0 0 0 0 16Z"/><path d="M12 13a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="m17.66 17.66 1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="m4.93 19.07 1.41-1.41"/><path d="m17.66 6.34 1.41-1.41"/></svg>
);
...
export const Volume1Icon: React.FC<IconProps> = ({ className }) => (
