...
import { PlayFilledIcon, PauseFilledIcon, ChevronLeftIcon, ChevronRightIcon, XIcon, ChevronUpIcon, ChevronDownIcon, LayersIcon, Volume1Icon, Volume2Icon, VolumeXIcon, PlusCircleIcon } from './icons';
